...
public class ReadCSV {
  ...
  static String icmp(String temp){
	...
	else if(dblLine>4&&dblLine<=6) temp="3";
	else temp="4";
	return temp;
  }
  
  static String percent(String temp){
	double dblLine=Double.parseDouble(temp);
  ...
  static void toFuzzy(String [] lineArr){
	lineArr[1]=icmp(lineArr[1]);
	lineArr[2]=icmp(lineArr[2]);
	lineArr[3]=icmp(lineArr[3]);
	lineArr[4]=percent(lineArr[4]);
	lineArr[5]=percent(lineArr[5]);
  }
  ...
  public static void main(String[] args) throws Exception{
	String csvFile = "C:\\Users\\Rolson\\Downloads\\projectcodes\\csvLogs\\mySet_000001.csv";
	BufferedReader br = new BufferedReader(new FileReader(csvFile));
	String line = "";
	String csvSplitBy = ",";
	PrintWriter pw=new PrintWriter("C:\\Users\\Rolson\\Downloads\\projectcodes\\processedLogs\\new_log1.txt");
    int line_no=0;
	double pt=0;
