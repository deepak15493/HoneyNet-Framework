...
public class ReadCSV {
  ...
  public static void main(String[] args) throws Exception{
	String csvFile = "merged_training.csv";	
	//String csvFile = "merged_testing.csv";
	BufferedReader br = new BufferedReader(new FileReader(csvFile));
	String line = "";
	String csvSplitBy = ",";
	PrintWriter pw=new PrintWriter("training_log.txt");	
	//PrintWriter pw=new PrintWriter("testing_log.txt");
    	int line_no=0;
	double pt=0;
